...
public:
    ...
    Euler(Ogre::Real y = 0.0f, Ogre::Real p = 0.0f, Ogre::Real r = 0.0f) :
    ...
    inline Ogre::Quaternion toQuaternion()
    {
        if(mChanged)
        {
            mCachedQuaternion = Ogre::Quaternion(mYaw, Ogre::Vector3::UNIT_Y) * Ogre::Quaternion(mPitch, Ogre::Vector3::UNIT_X)
